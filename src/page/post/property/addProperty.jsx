      ...
      <div className="container custom_top">
        <div className=" card card-primary">
          <div className="card-header">
            <h3 className="card-title custom_title_left">Thêm bài viết</h3>
    ...
    <strong>Lỗi!</strong> {error.area}.
                  ...
                  {listType.map((item, key) => (
                    <div key={key} className="form-check">
                      <input
                        ...
                        type="checkbox"
                      />
                      <label className="custom-label form-check-label">{item.name}</label>
                    </div>
                  ))}
                </div>
              )}
              ...
              <Dropzone onDrop={(acceptedFiles) => handleFile(acceptedFiles)}>
                {({ getRootProps, getInputProps }) => (
                  <div className="form-group border_file_custom">
    ...
    <strong>Lỗi!</strong> {error.content}.
              ...
              <div className="form-group">
                ...
                <div className="form-check">
                  <input
                    ...
                    name="radio1"
                  />
                  <label className="form-check-label custom-label">Đăng bán</label>
                </div>
                <div className="form-check">
                  <input
                    ...
                    name="radio1"
                  />
                  <label className="form-check-label custom-label">Phác thảo</label>
                </div>
         ...
         { isLoad &&  <div className="overlay-wrapper">
            <div className="overlay">
                <div className="text-bold pt-2">Đang thêm <i className="fa fa-spinner fa-spin" ></i>
                </div>
             </div>
        </div>}
